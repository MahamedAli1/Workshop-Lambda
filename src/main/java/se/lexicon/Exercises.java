...
public class Exercises {
    ...
    private final static DataStorage storage = DataStorageImpl.getInstance();
    ...
    */
    ...
    public static void exercise2(String message) {
        System.out.println(message);
        List<Person> result = storage.findMany(person -> "Female".equalsIgnoreCase(String.valueOf(person.getGender())));
        result.forEach(System.out::println);
        System.out.println("----------------------");
    }
    ...
    public static void exercise3(String message) {
        ...
        List<Person> result = storage.findMany(person -> !person.getBirthDate().isBefore(date));
        result.forEach(System.out::println);
        System.out.println("----------------------");
    }
    ...
    public static void exercise4(String message) {
        System.out.println(message);
        Person result = storage.findOne(person -> person.getId() == 123);
    ...
    public static void exercise5(String message) {
        ...
        String result = storage.findOneAndMapToString(
                ...
                person -> String.format("Name: %s %s born %s",
                        person.getFirstName(),
                        person.getLastName(),
    ...
    public static void exercise6(String message) {
        ...
        List<String> result = storage.findManyAndMapEachToString(
                person -> "Male".equalsIgnoreCase(String.valueOf(person.getGender())) && person.getFirstName().startsWith("E"),
    ...
    public static void exercise7(String message) {
        ...
        List<String> result = storage.findManyAndMapEachToString(
                ...
                person -> String.format("%s %s %d years",
                        person.getFirstName(),
                        person.getLastName(),
                        person.getId())
        );
    ...
    public static void exercise8(String message) {
        System.out.println(message);
        storage.findAndDo(
                person -> "Ulf".equals(person.getFirstName()),
                System.out::println
        );
        System.out.println("----------------------");
    }
